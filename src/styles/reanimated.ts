...
import {
  ...
  TDerivedDimension,
  TDerivedNumber,
} from "../types/styles/reanimated";
export function useColors(value: TDerivedColor) {
...
export function useNumberSizes(value: TDerivedNumber) {
...
export function useDimensionSizes(value: TDerivedDimension) {
